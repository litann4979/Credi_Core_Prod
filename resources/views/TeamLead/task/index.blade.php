...
<head>
    ...
    /* Existing pagination styles (unchanged) */
.pagination-wrapper {
    margin-top: 1.5rem;
    display: flex;
    justify-content: center;
...
.pagination .page-item:last-child .page-link {
    padding: 0.5rem 1.25rem; /* Slightly wider padding for better click area */
    font-weight: 700; /* Bolder text for navigation buttons */
    text-transform: uppercase; /* Uppercase for emphasis */
    letter-spacing: 0.5px; /* Subtle spacing for readability */
    border-radius: var(--radius-md); /* Consistent with page links */
}
...
/* Optional: Add arrows for visual cue */
...
/* Fallback colors (if variables are not defined) */
:root {
    --gray-50: #f9fafb;
    --gray-100: #f3f4f6;
    --gray-200: #e5e7eb;
...
<body>
    ...
    <div class="search-box" style="margin-bottom: 12px;">
        <input type="text" class="search-input" id="employeeSearch" placeholder="Search employees..." oninput="filterEmployees()">
 ...
 <script>
    ...
    let currentPage = 1;
    let totalPages = 1;
    let perPage = 5; // Adjust as needed
    ...
    function fetchTasks() {
        fetch('/team-lead/assigned-tasks', {
            headers: {
...
function filterEmployees() {
    ...
    function renderTasks() {
        ...
        paginatedTasks.forEach(task => {
            ...
            // Display assignees with fallback for avatar
