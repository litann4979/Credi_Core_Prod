    ...
    <div class="main-content">
        ...
        <div class="w-full max-w-7xl mx-auto">
            ...
            <div class="dashboard-card p-8 mb-8">
                ...
                @endif
                <form id="compOffForm" method="POST" action="{{ route('team_lead.comp-off.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @csrf
                    <div>
                    ...
                    <div class="md:col-span-2 flex justify-end space-x-4">
                        <button type="button" onclick="window.location.href='{{ route('team_lead.comp-off.index') }}'" class="btn-secondary">Cancel</button>
