...
<head>
    ...
    <title>Dashboard - Operations Management System</title>
    <link rel="icon" type="image/png" href="{{ asset('logo1.png') }}">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
   @include('Opearation.Components.css')
   <style>
        :root {
...
<body>
    @include('Opearation.Components.sidebar') <!-- Adjust to Operations namespace if needed -->

    <div class="main-content">
        @include('Opearation.Components.header', ['title' => 'Operations Dashboard', 'subtitle' => 'Manage all teams and track performance'])

        <div class="dashboard-container">
            <!-- Dashboard Header -->
            <div class="dashboard-header">
                <h1 class="dashboard-title">Reports Overview</h1>
                <p class="dashboard-subtitle">Monitor all teams' performance and track key metrics</p>
            </div>
                ...
                <div class="table-content">
                    <div style="padding: 1.5rem;">
                        ...
                        <div class="filter-section">
                            <form method="GET" action="{{ route('operations.reports.index') }}" class="filter-form">
                        ...
                        @if($leads->count())
                            <div class="mb-3">
                                <a href="{{ route('operations.export', ['type' => request('filter', 'total')]) }}" class="btn btn-success">
...
<div id="task-list">
    @forelse ($tasks as $task)
        @php
            $category = $task->target_type === 'all' ? 'all' : 'individual';
        @endphp
        <div class="task-item" data-type="{{ $task->target_type }}" data-category="{{ $category }}">
    ...
    @endforelse
            ...
            <!-- Team Members Overview (unchanged) -->
            {{-- <div class="team-card">
    ...
    <!-- Employee Details Modal (unchanged) -->
...
@include('Opearation.Components.script')
    <script>
        ...
        function viewMemberDetails(userId) {
            fetch(`/operations/employee/details/${userId}`)
        ...
        function exportLeads(type) {
            window.location.href = `/operations/export-report/${type}`;
        }
