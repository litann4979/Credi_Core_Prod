...
@endif
                <form id="leaveForm" method="POST" action="{{ route('operations.leave.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @csrf
                    <div>
                    ...
                    <div class="md:col-span-2 flex justify-end space-x-4">
                        <button type="button" onclick="window.location.href='{{ route('operations.leave.index') }}'" class="btn-secondary">Cancel</button>
