...
<body>
    ...
    <div class="notifications-container">
        @include('Opearation.Components.header', ['title' => 'Notification Management', 'subtitle' => 'Check your notifications and manage tasks efficiently.'])
  ...
  function fetchNotifications() {
                ...
                fetch('/operations/notifications/fetch', {
                    headers: {
...
function downloadSalarySlip(salarySlipId) {
    ...
    fetch(`/operations/salary-slips/${salarySlipId}/download`, {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': csrfToken
        }
...
function markNotificationAsRead(notificationId, notificationElement) {
    ...
    fetch(`/operations/notifications/${notificationId}/mark-read`, {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': csrfToken,
...
function updateUnreadCount() {
    fetch('/operations/notifications/count-unread')
...
// Show task details in modal and mark notification as read
            ...
            function updateTaskStatus(taskId, status, message, progress) {
                ...
                fetch(`/operations/tasks/${taskId}/update-status`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': csrfToken,
                        'Content-Type': 'application/json',
