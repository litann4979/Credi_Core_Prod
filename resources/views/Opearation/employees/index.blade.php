...
<body>
    ...
    <div class="main-content">
        @include('Opearation.Components.header', ['title' => 'Teams', 'subtitle' => 'Manage your team members and employees'])

        <div class="teams-container">
            <!-- Page Header -->
            <div class="page-header">
                <h1 class="page-title">Employee Management</h1>
                <p class="page-subtitle">Add, edit, and manage your employees efficiently</p>
            </div>
            ...
            <div class="teams-layout">
                ...
                <div class="employee-form-section">
                    ...
                    <form class="employee-form" id="employeeForm" method="POST" action="{{ route('operations.employees.store') }}" enctype="multipart/form-data">
                        @csrf
      ...
      <div class="form-group">
              <label for="teamLeadId" class="form-label">
                  <i class="fas fa-user-tie"></i>
                    Assign Team Lead <span class="required">*</span>
              </label>
             <select id="teamLeadId" name="team_lead_id" class="form-input" required>
...
<td>
    <div class="d-flex align-items-center gap-2">
        ...
        <form action="{{ $employee->deleted_at
            ? route('operations.employees.activate', $employee->id)
            : route('operations.employees.deactivate', $employee->id)
...
@endforelse
    ...
    <div class="modal-overlay" id="successModal">
        <div class="modal-content">
            ...
            <h3 class="modal-title" id="modalTitle">Employee Created Successfully!</h3>
    ...
    const employeeData = {
        ...
        employee_role: formData.get('employee_role') || '',
        team_lead_id: formData.get('team_lead_id') || '', // Include team_lead_id
    ...
    const formData = new FormData(form); // Get all form data, including file input
    ...
    .then(data => {
        ...
        employees.push(data.employee); // Assuming backend returns the created employee
        filteredEmployees = [...employees];
        renderEmployeesTable();
        resetForm();
        document.getElementById('modalTitle').textContent = 'Employee Created Successfully!';
        showSuccessModal();
    ...
    .catch(error => {
        ...
        function editEmployee(id) {
           ...
           document.getElementById('teamLeadId').value = employee.team_lead_id;
    ...
    .then(data => {
        if (data.success) {
            ...
            if (index !== -1) {
                employees[index] = { ...employees[index], ...data.employee };
                filteredEmployees = [...employees];
                renderEmployeesTable();
                resetForm();
                document.getElementById('modalTitle').textContent = 'Employee Updaqted Successfully!';
                showSuccessModal();
    ...
    .catch(error => {
        console.error('Error:', error);
        showNotification(error.errors || 'Failed to update employee. Please try again.', 'error');
    });
}
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <!-- Toggle Form -->
                        <form action="/operations/employees/${employee.id}/${isActive ? 'deactivate' : 'activate'}" method="POST" class="toggle-form m-0 p-0">
   ...
   function showNotification(message, type = 'info') {
    ...
    if (type === 'error' && typeof message === 'object') {
        ...
        for (const [field, errors] of Object.entries(message)) {
            errorMessage += `<br>- ${field}: ${errors.join(', ')}`;
        }
