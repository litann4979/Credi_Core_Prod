        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
            ...
            <div class="glass-card kpi-a p-3 hover:scale-[1.01] transition-all cursor-pointer">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-gray-200 font-semibold uppercase tracking-wider text-sm">Total Leads Entry</span>
            ...
            <div class="glass-card kpi-b p-3 hover:scale-[1.01] transition-all cursor-pointer">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-gray-200 font-semibold uppercase tracking-wider text-sm">Personal Loan Entry</span>
                    <span class="text-2xl float-icon">💰</span>
                </div>
                    ...
                    <div class="overflow-x-auto overflow-y-auto flex-1">
                        ...
                        <thead>
                            <tr class="border-b border-[#2a4b7a] bg-[#0a1733]">
                                ...
                                <th class="px-6 py-4 text-right text-blue-200 font-bold text-sm uppercase tracking-wider">Personal Loan Entry</th>
                                <th class="px-6 py-4 text-center text-blue-200 font-bold text-sm uppercase tracking-wider">Target Achieved</th>
