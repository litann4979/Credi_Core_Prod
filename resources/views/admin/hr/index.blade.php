...
<body>
                ...
                <div class="stat-card-modern active-card">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <p class="stat-label">Active HRs</p>
                        </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        @if($teamlead->trashed())
                                            <form action="{{ route('admin.hr.activate', $teamlead->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                        ...
                                        @else
                                            <form action="{{ route('admin.hr.deactivate', $teamlead->id) }}" method="POST" style="display:inline;">
                                                @csrf
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <div class="d-flex flex-column align-items-center justify-content-center text-gray-400">
                                        ...
                                        <p class="mb-0 fw-medium">No HR found.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-5">
                    <form id="operationForm" action="{{ route('admin.hr.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
    ...
    <script>
        function resetForm() {
            ...
            document.getElementById('operationForm').action = "{{ route('admin.hr.store') }}";
            ...
            document.getElementById('submitButton').innerHTML = '<i class="fas fa-save me-2"></i>Add HR';
            document.getElementById('operationModalLabel').innerHTML = '<i class="fas fa-user-plus me-2"></i>Add HR';
        }

        function editOperation(id, name, email, phone, address, photo) {
            document.getElementById('operationForm').action = "{{ url('admin/hr') }}/" + id;
            ...
            document.getElementById('submitButton').innerHTML = '<i class="fas fa-save me-2"></i>Update HR';
            document.getElementById('operationModalLabel').innerHTML = '<i class="fas fa-user-edit me-2"></i>Update HR';
