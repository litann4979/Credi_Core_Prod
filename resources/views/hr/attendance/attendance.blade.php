...
<body>
    ...
    <div class="main-content">
         @include('hr.Components.header', ['title' => 'Attendance Management', 'subtitle' => 'Give your Attendance here'])
...
function checkTodayStatus() {
    ...
    try {
        const response = await fetch(`/hr/attendance/${id}`, {
            headers: {
...
async function submitAttendance() {
    ...
    try {
        const url = isCheckedIn ? '/hr/attendance/check-out' : '/hr/attendance/check-in';
...
function openComplaintModal() {
        ...
        async function submitComplaint(event) {
            ...
            try {
                const response = await fetch('/hr/attendance/complaint', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                        'Content-Type': 'application/json',
