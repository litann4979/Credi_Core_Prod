...
class OperationLeaveController extends Controller
{
       /**
     * Show the leave application form and recent leave histories.
     *
    ...
    public function create()
    {
        ...
        return view('Opearation.leave.index', compact('hrUsers', 'leaveHistories'));
    }
...
public function store(Request $request)
{
    ...
    return redirect()->route('operations.leave.index')
