...
class TLCompOffController extends Controller
{
   public function create()
    {
        ...
        return view('TeamLead.comp-off.index', compact('userName', 'compOffHistories'));
    }
    ...
    public function store(Request $request)
{
    ...
    return redirect()->route('team_lead.comp-off.index')
